...
function rendersongs() {
  ...
  songList.forEach((song) => {
    ...
    newcardmain.innerHTML = `
       ...
       <button class="btn" id="btn-ver-detalles"><a href="../Detalles2/detalles.html" onclick="guardariddetalle(${song.idunico})" style="text-decoration: none; color:  black;"><i class="fa-solid fa-play"></i></a></button>
...
//             <br>
//             <!--BOTON IR A VISTA DETALLES-->
//             <a href="./detalles.html" onclick="guardariddetalle(${song.idunico})">Detalles</a>
...
function guardariddetalle(idunico) {
  localStorage.setItem("detalleLS", JSON.stringify(idunico));
}
